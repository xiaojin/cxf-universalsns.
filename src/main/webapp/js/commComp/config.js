...
(function($){
	...
	if (ec2) {
	    conf = {
	        ...
	        LINKEDIN_CALLBACK : "http://54.187.87.218:9090/linkedin.html",
	        ...
	        GOOGLE_CALLBACK : "http://ec2-54-187-87-218.us-west-2.compute.amazonaws.com:9090/google.html",
	        FACEBOOK_CLIENTID : "481141291987497",
	        FACEBOOK_CALLBACK : "http://54.187.87.218:9090/facebook.html",
	        PROXY : "http://54.187.87.218:9090/AccessToken",
	        TWITTER : "Twitter",
	        FACEBOOK : 'Facebook',
